...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { endereco: @pessoa.endereco, idade: @pessoa.idade, nome: @pessoa.nome, user_id: @pessoa.user_id }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { endereco: @pessoa.endereco, idade: @pessoa.idade, nome: @pessoa.nome, user_id: @pessoa.user_id }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
